...
# $Header: c:/cvs/repo/mosh/mbin/7zs.sh,v 1.86 2017-11-23 03:35:29 a Exp $
...
1>&2 echo "
What: $CMD [Options] [Actions] [archive] [args] .. 7z/zip encrypt args into archive with ssh key
Actions:
